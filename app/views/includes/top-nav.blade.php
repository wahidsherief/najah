                            ...
                            <div class="mega-menu-content">
                                <div class="row">
                                    ...
                                    <ul class="col-md-4 mega-menu-submenu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-angle-right"></i> Buttons & Icons
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-angle-right"></i> Extended Modals
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-angle-right"></i> Datepaginator
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                    ...
                                    <ul class="col-md-4 mega-menu-submenu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-angle-right"></i> Form Controls
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-angle-right"></i> Multiple File Upload
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-angle-right"></i> Dropzone File Upload
                                            </a>
                                        </li>
                                    </ul>
                                </div>
